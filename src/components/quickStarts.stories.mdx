...
Amazon Chime SDK Components provide you the capability to build out a realtime meeting experience easily. It has a dependency on the [amazon-chime-sdk-js](https://github.com/aws/amazon-chime-sdk-js).

Amazon Chime SDK Components are aimed at accelerating your Amazon Chime SDK application development.
...
const MyApp = () => {
  ...
  const joinMeeting = async () => {
    ...
    // Start the meeting session to join the meeting
